 ...
 * 2017.10.23
 * file name : index.js
 * http://1boon.kakao.com/ch/trending.json에서 데이터 파싱
 * 데이터 10개씩 파싱해서 긁어옴
 * */

//데이터를 파싱해올 url설정
var url = 'http://1boon.kakao.com/ch/trending.json?pagesize=10&page=';
...
$(window).scroll(function (event){
    var currentScrollPosition = window.scrollY / maxScrollHeight() * 100;
